...
import { Sun, Moon, Play, Pause, Eye, EyeOff, Zap, Shuffle, Volume2, VolumeX, LayoutGrid } from "lucide-react"
      ...
      <Card className="bg-background/20 backdrop-blur-sm w-fit mx-auto px-4 md:px-8 py-4 md:py-6 select-none pointer-events-auto">
        ...
        {mounted && (
          <div className="flex gap-1 md:gap-2 justify-center flex-wrap">
            <Link href="/gallery">
              <Button variant="ghost" size="sm" className="bg-white/20 hover:bg-white/30 h-8 w-8 md:h-10 md:w-10">
